...
#                        #item.Free(AIR_PRESSURE)
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[1].SetValue(DENSITY,         2500 )        
        self.model_part.Properties[1].SetValue(YOUNG_MODULUS,        2e+10 )        
        ...
        print "Linear elastic model selected for Lining_Concrete, description: Isotropic3D"
        ...
        self.model_part.Properties[3].SetValue(YOUNG_MODULUS,        1e+09 )        
        self.model_part.Properties[3].SetValue(POISSON_RATIO,          0.3 )
        self.model_part.Properties[3].SetValue(THICKNESS, 1.0 )
        self.model_part.Properties[3].SetValue(CONSTITUTIVE_LAW, Isotropic3D() )
        print "Linear elastic model selected for Building_1, description: Isotropic3D"
        self.model_part.Properties[4].SetValue(DENSITY,            0 )        
        self.model_part.Properties[4].SetValue(YOUNG_MODULUS,        1e+09 )        
        self.model_part.Properties[4].SetValue(POISSON_RATIO,          0.3 )
        self.model_part.Properties[4].SetValue(THICKNESS, 1.0 )
        self.model_part.Properties[4].SetValue(CONSTITUTIVE_LAW, Isotropic3D() )
        print "Linear elastic model selected for Building_2, description: Isotropic3D"
        self.model_part.Properties[5].SetValue(DENSITY,            0 )        
        self.model_part.Properties[5].SetValue(YOUNG_MODULUS,        1e+09 )        
        self.model_part.Properties[5].SetValue(POISSON_RATIO,          0.3 )
        self.model_part.Properties[5].SetValue(THICKNESS, 1.0 )
        self.model_part.Properties[5].SetValue(CONSTITUTIVE_LAW, Isotropic3D() )
        print "Linear elastic model selected for Building_3, description: Isotropic3D"
        self.model_part.Properties[6].SetValue(DENSITY,            0 )        
        self.model_part.Properties[6].SetValue(YOUNG_MODULUS,        1e+09 )        
        self.model_part.Properties[6].SetValue(POISSON_RATIO,          0.3 )
        self.model_part.Properties[6].SetValue(THICKNESS, 1.0 )
        self.model_part.Properties[6].SetValue(CONSTITUTIVE_LAW, Isotropic3D() )
        print "Linear elastic model selected for Building_4, description: Isotropic3D"
        self.model_part.Properties[7].SetValue(DENSITY,            0 )        
        self.model_part.Properties[7].SetValue(YOUNG_MODULUS,        1e+09 )        
        self.model_part.Properties[7].SetValue(POISSON_RATIO,          0.3 )
        self.model_part.Properties[7].SetValue(THICKNESS, 1.0 )
        self.model_part.Properties[7].SetValue(CONSTITUTIVE_LAW, Isotropic3D() )
        print "Linear elastic model selected for Building_5, description: Isotropic3D"
        self.model_part.Properties[8].SetValue(DENSITY,            0 )        
        self.model_part.Properties[8].SetValue(YOUNG_MODULUS,        1e+09 )        
        self.model_part.Properties[8].SetValue(POISSON_RATIO,          0.3 )
        self.model_part.Properties[8].SetValue(THICKNESS, 1.0 )
        self.model_part.Properties[8].SetValue(CONSTITUTIVE_LAW, Isotropic3D() )
        print "Linear elastic model selected for Building_6, description: Isotropic3D"
        self.model_part.Properties[9].SetValue(DENSITY,            0 )        
        self.model_part.Properties[9].SetValue(YOUNG_MODULUS,        1e+09 )        
        self.model_part.Properties[9].SetValue(POISSON_RATIO,          0.3 )
        self.model_part.Properties[9].SetValue(THICKNESS, 1.0 )
        self.model_part.Properties[9].SetValue(CONSTITUTIVE_LAW, Isotropic3D() )
        print "Linear elastic model selected for Building_7, description: Isotropic3D"
        self.model_part.Properties[10].SetValue(DENSITY,            0 )        
        self.model_part.Properties[10].SetValue(YOUNG_MODULUS,        1e+09 )        
        self.model_part.Properties[10].SetValue(POISSON_RATIO,          0.3 )
        self.model_part.Properties[10].SetValue(THICKNESS, 1.0 )
        self.model_part.Properties[10].SetValue(CONSTITUTIVE_LAW, Isotropic3D() )
        print "Linear elastic model selected for Building_8, description: Isotropic3D"
        self.model_part.Properties[11].SetValue(DENSITY,            0 )        
        self.model_part.Properties[11].SetValue(YOUNG_MODULUS,        1e+09 )        
        self.model_part.Properties[11].SetValue(POISSON_RATIO,          0.3 )
        self.model_part.Properties[11].SetValue(THICKNESS, 1.0 )
        self.model_part.Properties[11].SetValue(CONSTITUTIVE_LAW, Isotropic3D() )
        print "Linear elastic model selected for Building_9, description: Isotropic3D"
        self.model_part.Properties[12].SetValue(DENSITY,            0 )        
        self.model_part.Properties[12].SetValue(YOUNG_MODULUS,        1e+09 )        
        self.model_part.Properties[12].SetValue(POISSON_RATIO,          0.3 )
        self.model_part.Properties[12].SetValue(THICKNESS, 1.0 )
        self.model_part.Properties[12].SetValue(CONSTITUTIVE_LAW, Isotropic3D() )
        print "Linear elastic model selected for Building_10, description: Isotropic3D"
        self.model_part.Properties[13].SetValue(DENSITY,            0 )        
        self.model_part.Properties[13].SetValue(YOUNG_MODULUS,        1e+09 )        
        self.model_part.Properties[13].SetValue(POISSON_RATIO,          0.3 )
        self.model_part.Properties[13].SetValue(THICKNESS, 1.0 )
        self.model_part.Properties[13].SetValue(CONSTITUTIVE_LAW, Isotropic3D() )
        print "Linear elastic model selected for Building_11, description: Isotropic3D"
        self.model_part.Properties[14].SetValue(DENSITY,            0 )        
        self.model_part.Properties[14].SetValue(YOUNG_MODULUS,        1e+09 )        
        self.model_part.Properties[14].SetValue(POISSON_RATIO,          0.3 )
        self.model_part.Properties[14].SetValue(THICKNESS, 1.0 )
        self.model_part.Properties[14].SetValue(CONSTITUTIVE_LAW, Isotropic3D() )
        print "Linear elastic model selected for Building_12, description: Isotropic3D"
        self.model_part.Properties[15].SetValue(DENSITY,            0 )        
        self.model_part.Properties[15].SetValue(YOUNG_MODULUS,        1e+09 )        
        self.model_part.Properties[15].SetValue(POISSON_RATIO,          0.3 )
        self.model_part.Properties[15].SetValue(THICKNESS, 1.0 )
        self.model_part.Properties[15].SetValue(CONSTITUTIVE_LAW, Isotropic3D() )
        print "Linear elastic model selected for Building_13, description: Isotropic3D"
        self.model_part.Properties[16].SetValue(DENSITY,            0 )        
        self.model_part.Properties[16].SetValue(YOUNG_MODULUS,        1e+09 )        
        self.model_part.Properties[16].SetValue(POISSON_RATIO,          0.3 )
        self.model_part.Properties[16].SetValue(THICKNESS, 1.0 )
        self.model_part.Properties[16].SetValue(CONSTITUTIVE_LAW, Isotropic3D() )
        print "Linear elastic model selected for Building_14, description: Isotropic3D"
        self.model_part.Properties[17].SetValue(DENSITY,            0 )        
        self.model_part.Properties[17].SetValue(YOUNG_MODULUS,        1e+09 )        
        self.model_part.Properties[17].SetValue(POISSON_RATIO,          0.3 )
        self.model_part.Properties[17].SetValue(THICKNESS, 1.0 )
        self.model_part.Properties[17].SetValue(CONSTITUTIVE_LAW, Isotropic3D() )
        print "Linear elastic model selected for Building_15, description: Isotropic3D"
        self.model_part.Properties[18].SetValue(DENSITY,            0 )        
        self.model_part.Properties[18].SetValue(YOUNG_MODULUS,        1e+09 )        
        self.model_part.Properties[18].SetValue(POISSON_RATIO,          0.3 )
        self.model_part.Properties[18].SetValue(THICKNESS, 1.0 )
        self.model_part.Properties[18].SetValue(CONSTITUTIVE_LAW, Isotropic3D() )
        print "Linear elastic model selected for Building_16, description: Isotropic3D"
        self.model_part.Properties[19].SetValue(DENSITY,         2500 )        
        self.model_part.Properties[19].SetValue(YOUNG_MODULUS,        2e+10 )        
        self.model_part.Properties[19].SetValue(POISSON_RATIO,          0.3 )
        self.model_part.Properties[19].SetValue(THICKNESS, 1.0 )
        self.model_part.Properties[19].SetValue(CONSTITUTIVE_LAW, Isotropic3D() )
        print "Linear elastic model selected for Grouting, description: Isotropic3D"
        self.model_part.Properties[20].SetValue(DENSITY,         7620 )        
        self.model_part.Properties[20].SetValue(YOUNG_MODULUS,      2.1e+11 )        
        self.model_part.Properties[20].SetValue(POISSON_RATIO,          0.3 )
        self.model_part.Properties[20].SetValue(THICKNESS, 1.0 )
        self.model_part.Properties[20].SetValue(CONSTITUTIVE_LAW, Isotropic3D() )
        print "Linear elastic model selected for TBM_Steel, description: Isotropic3D"
        append_manual_data = True
        self.model_part.Properties[21].SetValue(CONSTITUTIVE_LAW, DummyConstitutiveLaw() )
