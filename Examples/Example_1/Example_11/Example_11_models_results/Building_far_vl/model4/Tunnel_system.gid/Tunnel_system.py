...
##################################################################
##################################################################
sys.path.append('./Tunnel_system.gid')
import Tunnel_system_include
from Tunnel_system_include import *
# calculate insitu-stress for geology_virgin.gid
model = Tunnel_system_include.Model('Tunnel_system',os.getcwd()+"/")
