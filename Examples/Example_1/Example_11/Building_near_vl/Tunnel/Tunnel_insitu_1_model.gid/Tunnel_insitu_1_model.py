...
##################################################################
##################################################################
sys.path.append('./Tunnel_insitu_1_model.gid')
import Tunnel_insitu_1_model_include
from Tunnel_insitu_1_model_include import *
# calculate insitu-stress for geology_virgin.gid
model = Tunnel_insitu_1_model_include.Model('Tunnel_insitu_1_model',os.getcwd()+"/")
