...
#import applications_interface_nonfree
#applications_interface_nonfree.Import_StructuralApplication = True
#applications_interface_nonfree.Import_KratosEkateAuxiliaryApplication = True
#applications_interface_nonfree.Import_KratosExternalConstitutiveLawsApplication = True
#applications_interface_nonfree.Import_KratosMKLSolversApplication = True
#applications_interface_nonfree.ImportApplications(kernel, kratos_applications_path)
