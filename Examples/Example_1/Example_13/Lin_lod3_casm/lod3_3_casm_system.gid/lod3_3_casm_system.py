...
##################################################################
##################################################################
sys.path.append('./lod3_3_casm_system.gid')
import lod3_3_casm_system_include
from lod3_3_casm_system_include import *
# calculate insitu-stress for geology_virgin.gid
model = lod3_3_casm_system_include.Model('lod3_3_casm_system',os.getcwd()+"/")
