...
##################################################################
##################################################################
sys.path.append('./vl_long_casm_system.gid')
import vl_long_casm_system_include
from vl_long_casm_system_include import *
# calculate insitu-stress for geology_virgin.gid
model = vl_long_casm_system_include.Model('vl_long_casm_system',os.getcwd()+"/")
