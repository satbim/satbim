...
##################################################################
##################################################################
sys.path.append('./lod2_30_le_system.gid')
import lod2_30_le_system_include
from lod2_30_le_system_include import *
# calculate insitu-stress for geology_virgin.gid
model = lod2_30_le_system_include.Model('lod2_30_le_system',os.getcwd()+"/")
