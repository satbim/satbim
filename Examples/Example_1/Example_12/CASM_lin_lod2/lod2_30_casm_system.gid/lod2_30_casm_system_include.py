...
#                        #item.Free(AIR_PRESSURE)
    ...
    def InitializeModel( self ):
        ...
        self.model_part.Properties[3].SetValue(DENSITY,         2500 )        
        self.model_part.Properties[3].SetValue(YOUNG_MODULUS,        2e+10 )        
        ...
        self.model_part.Properties[4].SetValue(DENSITY,         7620 )        
        self.model_part.Properties[4].SetValue(YOUNG_MODULUS,      2.1e+11 )        
        ...
        params1 = Vector(19)
        params1[0] =     100.25e+06 #Young's Modulus
        ...
        if( linear_elastic == False ):
            ...
            self.model_part.Properties[5].SetValue(MATERIAL_PARAMETERS, params1 )
            self.model_part.Properties[5].SetValue(CONSTITUTIVE_LAW, UPCSoil_explicit())
            self.model_part.Properties[2].SetValue(MATERIAL_PARAMETERS, params1 )
            self.model_part.Properties[2].SetValue(CONSTITUTIVE_LAW, UPCSoil_explicit())
        else:
            self.model_part.Properties[5].SetValue(MATERIAL_PARAMETERS, params1 )
            self.model_part.Properties[5].SetValue(CONSTITUTIVE_LAW, UPCSoil())
            self.model_part.Properties[2].SetValue(MATERIAL_PARAMETERS, params1 )
            self.model_part.Properties[2].SetValue(CONSTITUTIVE_LAW, UPCSoil())
